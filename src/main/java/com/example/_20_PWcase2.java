...
public class _20_PWcase2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileF.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverF.txt");
