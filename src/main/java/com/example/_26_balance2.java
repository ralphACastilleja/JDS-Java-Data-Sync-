...
public class _26_balance2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileI.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverI.txt");
