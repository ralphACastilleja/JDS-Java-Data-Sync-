...
public class _14_WWMov2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileC.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverC.txt");
