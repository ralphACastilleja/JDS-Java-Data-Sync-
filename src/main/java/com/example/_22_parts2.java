...
public class _22_parts2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileG.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverG.txt");
