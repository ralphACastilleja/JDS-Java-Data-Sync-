...
public class _12_Cat2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileB.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverB.txt");
