...
public class _28_WWMovHold2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileJ.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverJ.txt");
