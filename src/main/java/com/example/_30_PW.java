...
public class _30_PW {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileK.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverK.txt");
