...
public class _18_band2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileE.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverE.txt");
