...
public class _24_collet2 {
    ...
    private static final String START_DATE_FILE = getAppDataFilePath("2ndCsvFileH.txt");
    private static final String TURNOVER_FILE = getAppDataFilePath("TurnoverH.txt");
